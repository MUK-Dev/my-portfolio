export default function getProjectsData<T>(): T {
  return [
    ...
    {
      type: 'GAME',
      img: '/assets/projects/Desert Env.png',
      title: 'Desert Environment',
      description:
        'Created a desert environment using assets from Quixel Bridge',
      learned:
    ...
    {
      type: 'GAME',
      img: '/assets/projects/Castle Map.png',
      title: 'Castle Environment',
      description:
        'Created an environment using assets from Quixel Bridge and Unreal Sensie Video.',
      learned:
    ...
    {
      type: 'GAME',
      img: '/assets/projects/Learning Animations.png',
      title: 'Custom Animations',
      description: 'Created custom animations and a custom rig for character',
      learned:
        'I learned to rig and make custom animations in Blender and them import them and use them in UE5',
      skills: ['Unreal Engine 5', 'Blender'],
      blurHash:
        '|gIP9CRUABxZMzkCjFagRRI~fi#ls:WAWES1j?bE#FbYaeoeXQazWCk9ofI,WVW;t6nmowoLWVa$NEWWs.ofWCa#kBWDf8oze=bFjcWUn+oej[axsrj?jsWWWUoej[WWWBa$fifkWVkCj?jtayj[R%afjva_ofWVf8oJj]',
    },
    {
      type: 'GAME',
